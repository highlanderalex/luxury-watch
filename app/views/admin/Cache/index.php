                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
								...
								<tr>
                                    <td>Кэш инфо страниц</td>
                                    <td>Кэш инфо страниц. Кэшируется на 1 час</td>
                                    <td><a class="delete" href="<?=ADMIN;?>/cache/delete?key=info_pages"><i class="fa fa-fw fa-close text-danger"></i></a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
