        ...
        <div class="single-main">
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    <div class="col-md-5 single-top-left">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <li data-thumb="images/products/<?=$item->img;?>">
                                    <div class="thumb-image"> <img src="images/products/<?=$item->img;?>" data-imagezoom="true" class="img-responsive" alt=""/> </div>
                                </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    ...
                    $cats = \luxury\App::$app->getProperty('cats');
                    ?>
                    ...
                    <div class="product-one">
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                <a href="product/<?=$item['alias'];?>" class="mask"><img class="img-responsive zoom-img" src="images/products/<?=$item['img'];?>" alt="" /></a>
